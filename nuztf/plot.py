...
from nuztf.cat_match import get_cross_match_info, context_from_name
...
def lightcurve_from_science_image(
    source_name: str,
    data: pd.DataFrame,
    nu_name: list = None,
    ...
    source_coords, source_redshift, plot_title = context_from_name(
